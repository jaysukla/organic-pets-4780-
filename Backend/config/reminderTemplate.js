let reminderCreatedTemplate = (instance) => {
  ...
  * {
  ...
  This notification is the reminder for the Event : ${EventTitle}</p>
  <p style="line-height: 140%;">Time remaining ${reminderb4}</p>
...
module.exports = reminderCreatedTemplate;
